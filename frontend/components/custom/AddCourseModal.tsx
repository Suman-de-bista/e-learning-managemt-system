        ...
        <form id="addNewCourse" onSubmit={form.handleSubmit(onAddCourseSubmit)}>
          <DialogContent className="sm:max-w-sm">
            <DialogHeader>
              ...
              <DialogDescription>
                Add a new Course&apos;s information. Click save when you&apos;re done.
              </DialogDescription>
            </DialogHeader>
            <FieldGroup>
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    <FieldLabel htmlFor="add-course-title">Title</FieldLabel>
                    <Input
                      {...field}
                      id="add-course-title"
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    <FieldLabel htmlFor="add-course-level">Level</FieldLabel>
                    <Input
                      {...field}
                      id="add-course-level"
                      className="w-full bg-gray-100 border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    <FieldLabel htmlFor="add-course-duration-hours">Duration (hours)</FieldLabel>
                    <Input
                      {...field}
            ...
            <DialogFooter>
              ...
              <Button type="submit" form="addNewCourse" disabled={form.formState.isSubmitting}>
                Save changes
              </Button>
            </DialogFooter>
          </DialogContent>
