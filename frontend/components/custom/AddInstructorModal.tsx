          ...
          <DialogContent className="sm:max-w-sm">
            ...
            <FieldGroup>
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    <FieldLabel htmlFor="add-instructor-name">Name</FieldLabel>
                    <Input
                      {...field}
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    <FieldLabel htmlFor="add-instructor-expertise">Expertise</FieldLabel>
                    <Input
                      {...field}
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    <FieldLabel htmlFor="add-instructor-bio">Bio</FieldLabel>
                    <Input
                      {...field}
