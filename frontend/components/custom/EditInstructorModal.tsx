...
export function EditInstructorModal({
  ...
  const onEditInstructorSubmit = async (data: EditInstructorType) => {
    ...
    if (data.expertise && data.expertise !== instructor.expertise)
      updates.expertise = data.expertise ?? null;
        ...
        <form id="addNewInstructor" onSubmit={form.handleSubmit(onEditInstructorSubmit)}>
          <DialogContent className="sm:max-w-sm">
            <DialogHeader>
              ...
              <DialogDescription>
                Add a new Instructor&apos;s information.Click save when you&apos;re done.
              </DialogDescription>
            </DialogHeader>
            <FieldGroup>
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    <FieldLabel htmlFor="edit-instructor-name">Name</FieldLabel>
                    <Input
                      {...field}
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    <FieldLabel htmlFor="edit-instructor-expertise">Expertise</FieldLabel>
                    <Input
                      {...field}
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    <FieldLabel htmlFor="edit-instructor-bio">Bio</FieldLabel>
                    <Input
                      {...field}
            ...
            <DialogFooter>
              ...
              <Button type="submit" form="addNewInstructor" disabled={form.formState.isSubmitting}>
                Save changes
              </Button>
            </DialogFooter>
          </DialogContent>
