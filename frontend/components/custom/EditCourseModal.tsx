...
export function EditCourseModal({ course, isOpen, onClose, onSuccess }: EditCourseModalProps) {
  ...
  const onEditCourseSubmit = async (data: EditCourseType) => {
    ...
    if (data.duration_hours && data.duration_hours !== course.duration_hours)
      updates.duration_hours = data.duration_hours;
        ...
        <form id="editCourse" onSubmit={form.handleSubmit(onEditCourseSubmit)}>
          <DialogContent className="sm:max-w-sm">
            <DialogHeader>
              ...
              <DialogDescription>
                Edit the Course&apos;s information. Click save when you&apos;re done.
              </DialogDescription>
            </DialogHeader>
            <FieldGroup>
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    <FieldLabel htmlFor="edit-course-title">Title</FieldLabel>
                    <Input
                      {...field}
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    <FieldLabel htmlFor="edit-course-level">Level</FieldLabel>
                    <Input
                      {...field}
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    <FieldLabel htmlFor="edit-course-duration-hours">Duration (hours)</FieldLabel>
                    <Input
                      {...field}
            ...
            <DialogFooter>
              ...
              <Button type="submit" form="editCourse" disabled={form.formState.isSubmitting}>
                Save changes
              </Button>
            </DialogFooter>
          </DialogContent>
