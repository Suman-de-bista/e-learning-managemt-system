...
export default function LoginForm() {
  ...
  const handleInstructorSortChange = (key: InstructorSortKey) => {
    const nextDirection =
      instructorSortKey === key && instructorSortDirection === "asc" ? "desc" : "asc";
        ...
        >
          ...
          <div className="w-8/10 h-full flex m-auto py-10">
            <TabsContent value="users">
              <div className="flex w-full gap-8 justify-end my-2 p-4">
                <div className="flex w-full justify-end">
                  <SearchInput onSearch={searchUserHandler} />
                </div>
              </div>
              <UserTable
                users={users}
            ...
            <TabsContent value="instructors">
              <div className="flex w-full gap-8 justify-end my-2 p-4">
                <div className="flex w-full justify-end">
                  <SearchInput onSearch={searchInstructorHandler} />
                </div>
                <input
                  ref={fileInputRef}
                  type="file"
